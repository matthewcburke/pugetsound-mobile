...
//    	pushDeviceState(obtainDeviceState());
    ...
    private void pushDeviceState(JSONObject deviceState) {
    	try {
    		...
    		// get camera's location and rotation from the native code, gotmat it and put it in the JSON object
    		...
    		DebugLog.LOGI("position: " + cameraLoc[0] + ", " + cameraLoc[1] + ", " + cameraLoc[2]);
